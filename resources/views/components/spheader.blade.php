...
<body>
    ...
    <div class="side-bar">
        ...
        <nav class="navbar">
            ...
            <a href=""><i class="fa-solid fa-bars-staggered"></i><span>Guru</span></a>
            ...
            <a href="" onclick="return confirm('Anda Yakin Ingin Logout?');"><i class="fas fa-right-from-bracket"></i><span>Log out</span></a>
